...
if __name__ == "__main__":
    ...
    parser.add_argument("--weights_path", type=str, default="checkpoints/yolov3_cm500b10.pth", help="path to weights file")
    ...
    print("dectected==================",img_detections)
            ...
            for x1, y1, x2, y2, conf, cls_conf, cls_pred in detections:
                ...
                if last_x1!=-1:
                    ...
                    if abs(slope_ctr - slope_last_1)<0.4 or abs(slope_ctr - slope_last_2)<0.4:
                        if abs(ctr_x - last_ctr_x)<0.5*abs(last_x1 - last_x2) and abs(ctr_y - last_ctr_y)<0.5*abs(last_y1 - last_y2):
                            continue
